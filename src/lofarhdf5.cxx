...
void read_LOFARHDF5_files(struct spectra_info *s) {
  ...
  /* VLAD, Changed from 480 to 32768 due to the problem
   * that Joeri sorted out - at low freqs and high DMs the dispersive 
   * shift between neighbouring channels becomes more than this buffer size */
  s->spectra_per_subint = 32768;  // same as for Sigproc filterbank data
