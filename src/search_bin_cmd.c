...
usage(void)
{
  fprintf(stderr,"   [-ncand ncand] [-minfft minfft] [-maxfft maxfft] [-flo flo] [-fhi fhi] [-rlo rlo] [-rhi rhi] [-lobin lobin] [-overlap overlap] [-harmsum harmsum] [-numbetween numbetween] [-stack stack] [-interbin] [-noalias] [--] infile\n");
  fprintf(stderr,"      Searches a long FFT for binary pulsar candidates using a phase modulation search.\n");
  fprintf(stderr,"         -ncand: Number of candidates to try to return\n");
  fprintf(stderr,"                 1 int value between 1 and 10000\n");
  fprintf(stderr,"                 default: `100'\n");
  fprintf(stderr,"        -minfft: Power-of-2 length of the shortest miniFFT\n");
  fprintf(stderr,"                 1 int value between 8 and 1048576\n");
  fprintf(stderr,"                 default: `32'\n");
  fprintf(stderr,"        -maxfft: Power-of-2 length of the longest miniFFT\n");
  fprintf(stderr,"                 1 int value between 8 and 1048576\n");
  fprintf(stderr,"                 default: `65536'\n");
  fprintf(stderr,"           -flo: The low frequency (Hz) to check\n");
  fprintf(stderr,"                 1 float value between 0 and oo\n");
  fprintf(stderr,"                 default: `1.0'\n");
  fprintf(stderr,"           -fhi: The high frequency (Hz) to check\n");
  fprintf(stderr,"                 1 float value between 0 and oo\n");
  fprintf(stderr,"                 default: `2000.0'\n");
  fprintf(stderr,"           -rlo: The low Fourier frequency to check\n");
  fprintf(stderr,"                 1 int value between 0 and oo\n");
  fprintf(stderr,"           -rhi: The high Fourier frequency to check\n");
  fprintf(stderr,"                 1 int value between 0 and oo\n");
  fprintf(stderr,"         -lobin: The first Fourier frequency in the data file\n");
  fprintf(stderr,"                 1 int value between 0 and oo\n");
  fprintf(stderr,"                 default: `0'\n");
  fprintf(stderr,"       -overlap: Fraction of a short FFT length to shift before performing another\n");
  fprintf(stderr,"                 1 double value between 0.05 and 1.0\n");
  fprintf(stderr,"                 default: `0.25'\n");
  fprintf(stderr,"       -harmsum: Number of harmonics to sum in the miniFFTs\n");
  fprintf(stderr,"                 1 int value between 1 and 20\n");
  fprintf(stderr,"                 default: `3'\n");
  fprintf(stderr,"    -numbetween: Number of points to interpolate per Fourier bin (2 gives the usual bin value and an interbin)\n");
  fprintf(stderr,"                 1 int value between 1 and 16\n");
  fprintf(stderr,"                 default: `2'\n");
  fprintf(stderr,"         -stack: Number of stacked power spectra making up the data.  (The default means the data are complex amplitudes)\n");
  fprintf(stderr,"                 1 int value between 0 and oo\n");
  fprintf(stderr,"                 default: `0'\n");
  fprintf(stderr,"      -interbin: Use interbinning instead of full-blown Fourier interpolation.  (Faster but less accurate and sensitive)\n");
  fprintf(stderr,"       -noalias: Do not add aliased powers to the harmonic sum.  (Faster but less accurate and sensitive)\n");
  fprintf(stderr,"         infile: Input file name (no suffix) of floating point fft data.  A '.inf' file of the same name must also exist\n");
