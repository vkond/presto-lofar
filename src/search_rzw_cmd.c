...
usage(void)
{
  fprintf(stderr,"   [-ncand ncand] [-zlo zlo] [-zhi zhi] [-rlo rlo] [-rhi rhi] [-flo flo] [-fhi fhi] [-lobin lobin] [-zapfile zapfile] [-baryv baryv] [-photon] [--] infile\n");
  fprintf(stderr,"      Searches an FFT for pulsar candidates using a Fourier domain acceleration search.\n");
  ...
  fprintf(stderr,"        -zlo: The low Fourier frequency derivative to search\n");
  fprintf(stderr,"              1 int value between -2000000 and 2000000\n");
  fprintf(stderr,"              default: ` -50'\n");
  fprintf(stderr,"        -zhi: The high Fourier frequency derivative to search\n");
  fprintf(stderr,"              1 int value between -2000000 and 2000000\n");
  fprintf(stderr,"              default: `50'\n");
  fprintf(stderr,"        -rlo: The lowest Fourier frequency to search\n");
  fprintf(stderr,"              1 int value between 0 and oo\n");
  fprintf(stderr,"              default: `300'\n");
  fprintf(stderr,"        -rhi: The highest Fourier frequency to search\n");
  fprintf(stderr,"              1 int value between 0 and oo\n");
  fprintf(stderr,"        -flo: The lowest frequency (Hz) to search\n");
  fprintf(stderr,"              1 int value between 0 and oo\n");
  fprintf(stderr,"        -fhi: The highest frequency (Hz) to search\n");
  fprintf(stderr,"              1 int value between 0 and oo\n");
  fprintf(stderr,"      -lobin: The first Fourier frequency in the data file\n");
  fprintf(stderr,"              1 int value between 0 and oo\n");
  fprintf(stderr,"              default: `0'\n");
  fprintf(stderr,"    -zapfile: A file containing a list of freqs to ignore (i.e. RFI)\n");
  fprintf(stderr,"              1 char* value\n");
  fprintf(stderr,"      -baryv: The earth's radial velocity component (v/c) towards the observation (used to convert topocentric birdie freqs to barycentric)\n");
