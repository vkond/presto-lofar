...
usage(void)
{
  fprintf(stderr,"   [-plo plo] [-phi phi] [-rlo rlo] [-rhi rhi] [-psr psrname] [-candnum candnum] [-candfile candfile] [-usr] [-pb pb] [-x asinic] [-e e] [-To To] [-w w] [-wdot wdot] [-mak] [--] infile\n");
  fprintf(stderr,"      Generates a set of fake orbits and their Fourier modulation spectra for a binary candidate (usually generated by search_bin).  It tries to return the optimum fit for the binary candidate.\n");
  fprintf(stderr,"         -plo: The low pulsar period to check (s)\n");
  fprintf(stderr,"               1 double value between 0 and oo\n");
  fprintf(stderr,"         -phi: The high pulsar period to check (s)\n");
  fprintf(stderr,"               1 double value between 0 and oo\n");
  fprintf(stderr,"         -rlo: The low Fourier frequency bin to check\n");
  fprintf(stderr,"               1 double value between 0 and oo\n");
  fprintf(stderr,"         -rhi: The high Fourier frequency bin to check\n");
  fprintf(stderr,"               1 double value between 0 and oo\n");
  fprintf(stderr,"         -psr: Name of pulsar to check for (do not include J or B)\n");
  fprintf(stderr,"               1 char* value\n");
  fprintf(stderr,"     -candnum: Number of the candidate to optimize from candfile.\n");
  fprintf(stderr,"               1 int value between 1 and oo\n");
  fprintf(stderr,"    -candfile: Name of the bincary candidate file.\n");
  fprintf(stderr,"               1 char* value\n");
  fprintf(stderr,"         -usr: Describe your own binary candidate.  Must include all of the following (assumed) parameters\n");
  ...
  fprintf(stderr,"               default: `0'\n");
  fprintf(stderr,"         -mak: Determine optimization parameters from 'infile.mak'\n");
  fprintf(stderr,"       infile: Input fft file name (without a suffix) of floating point fft data.  A '.inf' file of the same name must also exist\n");
